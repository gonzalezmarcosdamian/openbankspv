    ...
    <footer className="bg-slate-900 border-t border-slate-800 py-10 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-sm text-slate-500">
          <a href="/openbankspv/#producto" className="hover:text-slate-300 transition-colors">Producto</a>
          <a href="/openbankspv/#como-funciona" className="hover:text-slate-300 transition-colors">Cómo funciona</a>
          <a href="/openbankspv/#contacto" className="hover:text-slate-300 transition-colors">Contacto</a>
        </div>
