      ...
      <nav className="fixed top-10 left-0 right-0 z-50 bg-white/90 backdrop-blur border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-slate-600">
            ...
            <Link href="/docs" className="hover:text-slate-900 transition-colors">Documentación</Link>
          </div>
          <div className="flex items-center gap-3">
            <a href="#contacto" className="text-sm text-slate-600 hover:text-slate-900 transition-colors hidden md:block">
              Hablar con el equipo
            </a>
            <a href="#contacto" className="text-sm bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors font-medium">
              Empezar
            </a>
          </div>
        </div>
